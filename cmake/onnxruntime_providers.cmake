...
if (onnxruntime_USE_ROCM)
  ...
  if (WIN32)
    set(ONNXRUNTIME_ROCM_LIBS roc::rocblas MIOpen)
  else()
  ...
  elseif(WIN32)
    set_property(TARGET onnxruntime_providers_rocm APPEND_STRING PROPERTY LINK_FLAGS "-DEF:${ONNXRUNTIME_ROOT}/core/providers/rocm/symbols.def")
  else()
