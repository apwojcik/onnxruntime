...
if (onnxruntime_USE_ROCM)
  ...
  elseif(WIN32)
    target_include_directories(onnxruntime_test_all PRIVATE ${onnxruntime_ROCM_HOME}/include ${MIOPEN_PATH}/include ${CMAKE_CURRENT_BINARY_DIR}/amdgpu/onnxruntime ${CMAKE_CURRENT_BINARY_DIR}/amdgpu/orttraining)
  endif()
endif()
...
if (NOT CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  ...
  if (onnxruntime_USE_ROCM)
    ...
    list(APPEND custom_op_lib_include ${onnxruntime_ROCM_HOME}/include ${MIOPEN_PATH}/include)
