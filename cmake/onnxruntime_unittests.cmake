...
if (onnxruntime_USE_ROCM)
  ...
  target_include_directories(onnxruntime_test_all PRIVATE  ${onnxruntime_ROCM_HOME}/hipfft/include ${onnxruntime_ROCM_HOME}/include ${onnxruntime_ROCM_HOME}/hiprand/include ${onnxruntime_ROCM_HOME}/rocrand/include ${CMAKE_CURRENT_BINARY_DIR}/amdgpu/onnxruntime ${CMAKE_CURRENT_BINARY_DIR}/amdgpu/orttraining C:/opt/miopen/include)
endif()
...
if (NOT CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  ...
  if (onnxruntime_USE_ROCM)
    ...
    list(APPEND custom_op_lib_include ${onnxruntime_ROCM_HOME}/include C:/opt/miopen/include)
